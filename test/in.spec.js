...
describe('spell-it in Indian English', function(){
	var spell;

	before(function(){
		spell = spellFactory('in');
	});
	...
	it('should return "five crore twelve lakh seven thousand one" if input is 51207001', function(){
		var output = spell(51207001);
		expect(output).to.equal('five crore twelve lakh seven thousand one');
	});
